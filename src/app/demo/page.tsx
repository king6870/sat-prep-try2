      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <h1 className="text-2xl font-bold text-gray-900">🎯 SAT Practice Test Demo</h1>
        ...
        {!testStarted ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              🎯 SAT Practice Test Demo
            </h2>
            
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h3 className="font-semibold text-blue-800 mb-2">🎮 Demo Mode - No Login Required!</h3>
              <p className="text-blue-700 text-sm">
                This is a demo version of the SAT prep test-taking module. 
                Experience the full functionality with 5,000+ real SAT questions!
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                >
                  <option value={5}>5 Questions (15 minutes) - Quick Demo</option>
                  <option value={10}>10 Questions (30 minutes) - Standard Demo</option>
                  <option value={20}>20 Questions (60 minutes) - Full Demo</option>
                </select>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  {Object.keys(weakAreas).length > 0 && (
                    <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                      <h3 className="text-lg font-semibold text-orange-800 mb-4">
                        🎯 Areas for Improvement (Demo Analysis)
                      </h3>
                            ...
                            return (
                              <div key={category} className="bg-white border border-orange-200 rounded-lg p-4">
                                ...
                                <div className="text-sm text-gray-600 mb-3">
                                  Demo Score: {categoryStats.percentage}% ({categoryStats.correct}/{categoryStats.total})
                                </div>
                                <div className="text-xs text-orange-700 bg-orange-100 p-2 rounded">
                                  💡 <strong>Practice Tip:</strong> Focus on {category.toLowerCase()} questions to improve.
                                  {category.toLowerCase().includes('math') || category.toLowerCase().includes('algebra') || category.toLowerCase().includes('geometry') ? 
                                    ' Review fundamental concepts and practice similar problems.' :
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <p className="text-blue-700 text-sm mb-4">
                      This was just a demo! Sign up for the full SAT prep platform to:
                    </p>
                    <ul className="text-sm text-blue-700 space-y-1 mb-4">
                      <li>• Access all 5,000+ questions</li>
                      <li>• Track your progress over time</li>
                      <li>• Get personalized study plans</li>
                      <li>• Take full-length practice tests</li>
                      <li>• Save your results and analytics</li>
                    </ul>
                    <button
                      onClick={() => router.push('/')}
                  ...
                  <div className="flex space-x-4">
                    <button
                      onClick={restartTest}
                      className="flex-1 py-3 px-6 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      🔄 Take Another Demo Test
                    </button>
                    <button
                      onClick={() => router.push('/')}
